...
// 구현 클래스(MyInterface 인터페이스를 구현하여 정의한 클래스)
class MyClass1 implements MyInterface {
    // 인터페이스에 정의된 추상 메서드를 오버라이딩 해야 한다.
    @Override
    public void print(){
...
public class MyClassExample {
    ...
    public static void main(String[] args) {
        ...
        test(mc1); //MyClass1의 참조값(주솟값)을 인자로 전달
        ...
        mi2.print(); // test2() 메서드에서 반환된 MyInterface를 구현한 구현 클래스의 주솟값
    }
