...
public class Lotto9_2 extends Frame implements ActionListener {
	// la[0] : lotto number
		...
		public void run() {
			...
			while (true) {
				...
				try {
					...
					// Lotto9_2.this.toString());
				} catch (Prize4Exception e1) {
					la5.setText("Prize 4");
					System.out.println("Prize 4 Exception called. " + Lotto9_2.this.toString());
				} catch (Prize3Exception e1) {
					la5.setText("Prize 3");
					System.out.println("Prize 3 Exception called. " + Lotto9_2.this.toString());
				} catch (Prize2Exception e1) {
					la5.setText("Prize 2");
					System.out.println("Prize 2 Exception called. " + Lotto9_2.this.toString());
				} catch (Prize1Exception e1) {
					la5.setText("Prize 1");
					System.out.println("Prize 1 Exception called. " + Lotto9_2.this.toString());
					System.exit(0);
				} catch (Exception e) {
					// e.printStackTrace();
