...
function accessId(){
    ...
    // let bgColor = document.getElementById("div1").style.backgroundColor;


    // 자바 스크립트에서는 문자열 비교시에도 비교 연산자를 사용한다.
    if(bgColor == "red"){
...
function inputTest(){
    ...
    /* innerText/innerHTML은 요소의 내용 (시작태그, 종료태그 사이에
        작성된 내용)을 얻어 오거나, 변경할 때만 사용 가능 */
...
function accessName(){
    ...
    // #name-div에 출력
    // document.getElementsByName("name-div").innerHTML = str;

    document.getElementById("name-div").innerHTML = str + "<br><br>선택된 개수 : " + count;
}
