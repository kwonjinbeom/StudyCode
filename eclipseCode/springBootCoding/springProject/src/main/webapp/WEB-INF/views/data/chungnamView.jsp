...
<%@ include file="/WEB-INF/views/common/common.jspf" %>
	...
	<script type="text/javascript">
		...
		$(function(){
			...
			/*
			// span 태그내 text 클래스를 클릭했을 때 상세 페이지로 이동
	...
	<div class="contentContainer container">
		...
		<ul id="list">
			<li id="item-template" class="item">
				<span class="item-light item-thumb"><a href="#" data-lightbox="roadtrip"><img /></a></span>
				<span class="text">
			...
			<div id="item-template" class="col-sm-6 col-md-4 item">
				<div class="thumbnail">
					...
					<div class="caption">
						...
						<p class="item-sub"></p>
						<p class="item-btn"><a class="btn btn-primary detailBtn" role="button">Button</a></p>
					</div>
				</div>
			</div>
		</div> 
