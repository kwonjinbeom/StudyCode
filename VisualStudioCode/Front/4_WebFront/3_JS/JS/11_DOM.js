...
document.getElementById("btn1").addEventListener("click",function(){
    ...
    console.log("parentNode"+li1.parentNode); //ul#test
    console.log("childnode"+li1.childNodes); //ch
...
document.getElementById("btn2").addEventListener("click",function(){
    ...
    document.getElementById("test").lastElementChild.style.backgroundColor = "deeppink";
    
    // console.log(document.getElementById("test").lastElementChild);
    ...
    console.log(list[2].previousElementSibling);
    console.log(list[2].previousSibling);
...
document.getElementById("btn3-1").addEventListener("click",function(){
    ...
    if (count <= 10){
        // 누적
        div.innerHTML = div.innerHTML+ "<div>"+count+"</div>";
        count++;
...
document.getElementById("btn3-2").addEventListener("click",function(){
    ...
    const child = document.createElement("div"); // div생성 0, 화면 배치 X
